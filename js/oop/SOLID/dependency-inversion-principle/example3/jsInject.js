// https://github.com/JeremyLikness/jsInject
'use strict';
...
(function (w) {
  ...
  JsInject.ERROR_RECURSION =
    'Recursive failure : Circular reference for dependency ';
  ...
  JsInject.prototype.invoke = function (fn, deps, instance, name) {
    ...
    if (stack[name]) {
      throw (
        ...
        name +
        ' : ' +
        JSON.stringify(Object.keys(stack))
      );
    }
  ...
  JsInject.prototype.register = function (name, annotatedArray) {
    ...
    this.container[name] = function () {
      var Template = function () {},
        ...
        deps =
          annotatedArray.length === 1
            ? annotatedArray[0].$$deps || []
